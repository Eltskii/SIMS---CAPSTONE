                           ...
                           <form class="form-horizontal span6" name=""  action="login.php" method="POST">
                                <div class="form-group">
                                  <div class="col-md-10">
                                    ...
                                    "MODAL_U_USERNAME">Username:</label>
                                    
                                    <div class="col-md-8">
                                       <input   id="MODAL_U_USERNAME" name="U_USERNAME" placeholder="Username" type="text" class="form-control input-sm" > 
                                ...
                                <div class="form-group">
                                  <div class="col-md-10">
                                    <label class="col-md-4 control-label" for="MODAL_U_PASS">Password:</label>
                                    
                                    <div class="col-md-8">
                                       <div style="position: relative;">
                                         <input id="MODAL_U_PASS" name="U_PASS" placeholder="Password" type="password" class="form-control input-sm" style="padding-right: 40px;">
                                         <button type="button" class="btn btn-link" id="modalTogglePassword" style="position: absolute; right: 5px; top: 50%; transform: translateY(-50%); padding: 2px 8px; color: #666; text-decoration: none;" title="Show/Hide Password">
                                           <i class="fa fa-eye" id="modalToggleIcon"></i>
                                         </button>
                                       </div>
                                       <div style="text-align: right; margin-top: 6px;">
                                         <a href="<?php echo web_root; ?>forgot-password.php" style="font-size: 12px; color: #27ae60;">
...
<script language="javascript" type="text/javascript">
        ...
        (function() {
            var modalToggleBtn = document.getElementById('modalTogglePassword');
            var modalPasswordInput = document.getElementById('MODAL_U_PASS');
            var modalToggleIcon = document.getElementById('modalToggleIcon');
            
            if (modalToggleBtn && modalPasswordInput && modalToggleIcon) {
                modalToggleBtn.addEventListener('click', function(e) {
                    e.preventDefault();
                    var type = modalPasswordInput.getAttribute('type') === 'password' ? 'text' : 'password';
                    modalPasswordInput.setAttribute('type', type);
                    
                    if (type === 'text') {
                        modalToggleIcon.classList.remove('fa-eye');
                        modalToggleIcon.classList.add('fa-eye-slash');
                    } else {
