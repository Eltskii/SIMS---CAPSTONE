  ...
  <div class="col-lg-12">
    <div class="page-header-row">
      <div>
        ...
        <p class="text-muted" style="margin:0">View students enrolled per course and semester.</p>
      </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="filter-header">
          <h3><i class="fa fa-filter"></i> Filter by Course and Semester</h3>
        </div>
        <div class="card-body">
          <div class="filter-row">
            <div class="form-group">
              <label><i class="fa fa-graduation-cap"></i> Course/Year</label>
...
<!-- Results Section -->
<?php if(isset($_POST['submit']) && isset($_POST['Course']) && isset($_POST['Semester'])): ?>
<div class="row">
  <div class="col-xs-12">
    <div class="card">
      <div class="results-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <div>
            <h3><i class="fa fa-users"></i> Students Enrolled per Semester</h3>
            <small style="opacity: 0.9;">
              <?php echo ($_POST['Course'] != 'All') ? 'Course/Year: ' . $_POST['Course'] . ' | ' : 'All Courses | '; ?>
...
<div class="stats-card">
  ...
  <span class="stats-label">Total Students for <?php echo $_POST['Semester']; ?> Semester<?php echo ($_POST['Course'] != 'All') ? ' in ' . $_POST['Course'] : ''; ?></span>
</div>
<?php endif; ?>

<!-- Print Form (Separate form for printing) -->
<form action="printpersemester.php" method="POST" target="_blank" id="printForm">
...
<!-- Empty state when required fields are missing -->
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <div class="empty-state">
      <i class="fa fa-exclamation-circle"></i>
      <h3>Incomplete Selection</h3>
      <p>Please select both a course/year and semester to generate the student list.</p>
    </div>
  </div>
</div>
<?php else: ?>
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <div class="empty-state">
      ...
      <h3>Ready to View Students by Semester?</h3>
      <p>Select a course/year and semester above to view enrolled students.</p>
    </div>
  </div>
</div>
<?php endif; ?>