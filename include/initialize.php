...
defined('SITE_ROOT') ? null : define ('SITE_ROOT', $_SERVER['DOCUMENT_ROOT'].DS.'SIMS');
...
require_once(LIB_PATH.DS."department-filter.php"); // Department filtering middleware
require_once(LIB_PATH.DS."api-response.php"); // API response helper for AJAX
