                  ...
                  <form class="form-horizontal span6" action="login.php" method="POST">
                      <div class="form-group">
                        <div class="col-md-12">
                          ...
                          "OLD_U_USERNAME">Username:</label> 
                                <input required="true"   id="OLD_U_USERNAME" name="U_USERNAME" placeholder="Username" type="text" class="form-control input" >  
                        </div> 
       
                        <div class="col-md-12">
                          <label class="control-label" for=
                          "OLD_U_PASS">Password:</label> 
                           <input required="true" name="U_PASS" id="OLD_U_PASS" placeholder="Password" type="password" class="form-control input ">
